...
function CreateNewTodo() {
  ...
  return (
    <div className='container min-h-screen mx-auto'>
      <div
      className=" content-center mx-auto  bg-[#17120f]  items-center min-h-[100%] p-4 rounded-lg mt-16 mb-4 max-w-4xl shadow-lg bg-gradient-to-br from-[#333333] via-[#191919] to-[#000000] text-white"
      >
